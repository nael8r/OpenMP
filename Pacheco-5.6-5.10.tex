...
\end{frame}
	...
	\subsection{Diretiva {\tt schedule}}
...
\end{frame}
	...
	\begin{frame}{Diretiva {\tt schedule}}
		\begin{itemize}
			\setlength\itemsep{1em}
	...
	\begin{frame}{Diretiva {\tt schedule} - {\tt runtime}}
		\begin{itemize}
	...
	\begin{frame}{Diretiva {\tt schedule} - Explorar Escalonadores}
		\begin{itemize}
			\setlength\itemsep{1em}
